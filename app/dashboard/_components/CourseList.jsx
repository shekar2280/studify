...
function CourseList() {
  ...
  return (
    <div className='mt-10'>
      ...
      onClick={GetCourseList} className="border-primar text-black"> <RefreshCw/> Refresh</Button>
      </h2>
      <div className='grid grild-col-2 md:gird-cols-2 lg:grid-cols-3 mt-2 gap-5'>
